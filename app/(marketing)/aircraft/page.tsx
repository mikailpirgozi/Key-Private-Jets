            ...
            <div className="relative rounded-2xl overflow-hidden border border-gold-500/20 bg-gradient-to-br from-luxury-black-lighter via-luxury-black to-luxury-black p-12 md:p-16">
              ...
              <div className="relative z-10 text-center">
                ...
                <h2 className="text-4xl md:text-5xl font-bold font-playfair mb-6">
                  <span className="block text-white mb-2">Not Sure Which</span>
                  <span className="text-gradient-gold">Aircraft is Right?</span>
                </h2>
                ...
                <p className="text-lg text-gray-300 mb-10 max-w-xl mx-auto leading-relaxed">
                  Our team can help you select the perfect aircraft based on your route, passenger count, budget, and specific requirements.
                </p>
                ...
                <div className="mt-8 pt-8 border-t border-gold-500/20">
                  <p className="text-sm text-gray-400">
                    <span className="text-gold-400 font-semibold">Expert Aviation Consultants</span> • Personalized recommendations
                  </p>
                </div>
              </div>
            </div>
